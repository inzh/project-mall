  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="address.id"
        @click="changeSelectedAddress(address, addressInfo)"
      >
        <span
          class="username"
...
export default {
  ...
  mounted () {
    ...
    this.$store.dispatch('getUserTradeInfo')
  },
  computed: {
    ...mapState({
  ...
  watch: {
    'addressInfo' (val, oldVal) {
      this.selectedAddress = val.find(item => item.isDefault == '1')
    }
  },
  methods: {
    changeSelectedAddress (address, addressInfo) {
