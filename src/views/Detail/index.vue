    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :zoomImg="skuInfo.skuImageList" />
          <!-- 小图列表 -->
            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSale in spuSaleAttrList" :key="spuSale.id">
                ...
                <dd
                  ...
                  :key="spuSaleAttr.id"
                  @click="
                    selectSaleAttr(spuSaleAttr, spuSale.spuSaleAttrValueList)
                  "
...
export default {
  ...
  methods: {
    selectSaleAttr (spuSaleAttr, spuSaleAttrValueList) {
      if (spuSaleAttr.isChecked == '1') {
